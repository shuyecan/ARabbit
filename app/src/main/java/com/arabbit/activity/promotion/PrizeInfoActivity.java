...
public class PrizeInfoActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prizeinfo);
...
//        prRank.setText(rank);
    ...
    public void delPrize() {
        String pr_id = getIntent().getStringExtra("pr_id");
        try {
            model.delPrize(pr_id, new IModelResult<List<PrizeListEntity.ListsBean>>() {
                @Override
                public void OnSuccess(List<PrizeListEntity.ListsBean> entity) {
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.pr_ed:
                try {
                    ...
                    if(endTimeStamp >= currentTimeMillis){
                        Intent intent = new Intent(mActivity, UpdatePrizeActivity.class);
            ...
            case R.id.close:
                ...
                break;
            case R.id.pr_user:
                Intent intent1 = new Intent(mActivity, PrizeUserActivity.class);
