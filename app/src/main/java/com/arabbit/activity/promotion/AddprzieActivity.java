...
public class AddprzieActivity extends BaseActivity implements CustomSpinner.OnSpinnerListener {
...
//        Log.e("CCC",",type值是:"+ type);
        school_id =getIntent().getStringExtra("school_id");
        model = new SocialModel(AddprzieActivity.this);
        initSpinner();
        initTitle();
        }
...
//                String Prrank = UIUtils.getStrTextView(prRank);
...
//                }
                ...
                addPrize(Prname,gfimg, Prinfo, Prcontent, selectPosition+"", Prnum, Prrate, pt_id);
                break;
            case R.id.close:
    ...
    public void addPrize(final String prname,final String gfimgs, final String info, final String content, final String rank,
                         final String num, final String rate, final String pt_id) {
        try {
            model.addPrize(prname,gfimgs, info, content, rank, num,rate, pt_id,
