...
import com.arabbit.adapter.PrizeUserAdapter.Callback;
...
public class PrizeUserActivity extends BaseActivity implements AdapterView.OnItemClickListener,Callback {
    ...
    public void prizeList(int page_no) {
        pr_id = getIntent().getStringExtra("pr_id");
//        Log.e("aaa","集合数prizeList量："+pr_id);
        try {
            model.getPrizeUser(pr_id,page_no, new IModelResult<UserHadprizeEntity>() {
                @Override
    ...
    PrizeUserAdapter mAdapter;

    private void initList() {
        mAdapter = new PrizeUserAdapter(mActivity, mList, this);
