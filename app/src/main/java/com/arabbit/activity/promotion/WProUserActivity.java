...
public class WProUserActivity extends BaseActivity implements AdapterView.OnItemClickListener,PrizeUserAdapter.Callback {
    ...
    public void prizeList(int pageno) {
       ...
       // Log.e("aaa","中奖id："+pt_id);
        try {
            model.getWProUser(pt_id,pageno, new IModelResult<UserHadprizeEntity>() {
                @Override
