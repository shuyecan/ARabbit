...
public class NickNameActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initTile();
        initEdit();
        name = CommonUtils.formatNull(getIntent().getStringExtra("name"));
    ...
    private void initTile() {
        titleValue.setText(R.string.name);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.iv_back:
                ...
                break;
            case R.id.tv_add:
                name = UIUtils.getStrEditView(etName);
...
//                    ToastUtils.showToastShort("用户名长度应在4-15位之间");
//                    return;
//                }
    ...
    public void updateUserInfoNickname() {
        name = UIUtils.getStrEditView(etName);
        try {
            model.updateUserInfoNickname(name, new IModelResult<EmptyEntity>() {
                @Override
