...
public class AddShopcpgoodActivity extends BaseActivity {
    ...
    public void AddShopcpGood(final String user_id,final String cpname,final String info, final String num,
                              final String cp_price, final String preprice,final String pullon,
                              final String content, final String cpimg) {
        try {

            model.addShopcpGood(user_id,cpname, info, num, cp_price, preprice,pullon,
   ...
   //是否上架
                ...
                AddShopcpGood(user_id,cpName, cpInfo, cpNum, cpPrice, cpPreprice,cpPullon,
                        cpContent, cpimg);
                break;
        }
    }
