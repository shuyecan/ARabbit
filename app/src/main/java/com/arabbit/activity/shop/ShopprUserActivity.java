...
public class ShopprUserActivity extends BaseActivity implements AdapterView.OnItemClickListener,ShopprUserAdapter.Callback {
...
//        Log.e("aaa","集合数prizeList量："+pr_id);
        try {
            model.getUserShopprList(pr_id,page_no, new IModelResult<HadShopprEntity>() {
                @Override
