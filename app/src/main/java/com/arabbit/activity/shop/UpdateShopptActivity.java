...
public class UpdateShopptActivity extends BaseActivity implements CustomSpinner.OnSpinnerListener{
...
//                }
                ...
                UpdateShopPt(pt_id, Title,pttype_text, Far, Starttime, Endtime, Rule);
                break;
            case R.id.close:
    ...
    public void UpdateShopPt( final String pt_id, final String title,final String type, final String far, final String starttime, final String endtime,
                           final String rule) {
        try {
            Log.e("aaa","活动类型:"+type);
            model.updateShopPt( pt_id, title,type, far, starttime, endtime, rule,
