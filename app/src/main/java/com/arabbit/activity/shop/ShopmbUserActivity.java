...
public class ShopmbUserActivity extends BaseActivity implements AdapterView.OnItemClickListener,ShopmbUserAdapter.Callback {
    ...
    public void userShopmbList(final int page) {
        ...
        try {
            model.getUserShopmbList(mb_id,page,new IModelResult<HadShopmbEntity>() {
                @Override
