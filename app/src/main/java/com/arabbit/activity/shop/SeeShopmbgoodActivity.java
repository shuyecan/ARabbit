...
public class SeeShopmbgoodActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_see_shopmbgood);
    ...
    @OnClick({R.id.iv_back, R.id.close, R.id.mb_buy, R.id.mb_rule})
