...
public class StorembShopActivity extends BaseActivity {
    ...
    private void  getNearbyMbList(int far,String type){
        model.getNearbyMbList(latud+"",londe+"",far,type,new IModelResult<List<ShopInfoEntity>>() {
            @Override
