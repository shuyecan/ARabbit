...
public class AddShopprActivity extends BaseActivity implements CustomSpinner.OnSpinnerListener{
...
//        });
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.commit:
                ...
                addPrize(Prname,primg, Prinfo, Prcontent, selectPosition+"", Prnum, Prrate, pt_id, Prprice);
                break;
            case R.id.close:
    ...
    public void addPrize(final String prname,final String gfimgs, final String info, final String content, final String rank,
                         final String num, final String rate, final String pt_id, final String price) {
        try {
            model.addShopPrize(prname,gfimgs, info, content, rank, num,rate, pt_id, price,
