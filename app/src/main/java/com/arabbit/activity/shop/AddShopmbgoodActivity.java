...
import com.arabbit.activity.promotion.AddgiftActivity;
...
public class AddShopmbgoodActivity extends BaseActivity {
    ...
    public void AddShopmbGood(final String mb_id,final String mbname,final String info, final String num,
        ...
        try {
            ...
            model.addShopmbGood(mb_id,mbname, info, num, mb_price, preprice, starttime, endtime,
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.commit:
                ...
                AddShopmbGood(mb_id,mbName, mbInfo, mbNum, mbPrice, mbPreprice,
