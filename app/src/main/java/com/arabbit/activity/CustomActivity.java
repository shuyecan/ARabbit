 ...
 *
 */
public class CustomActivity extends AppCompatActivity implements IViewLoad {
    private static List<CustomActivity> activityList = new LinkedList<>();
     ...
     * @param clazz
     */
    public static void destroyActivity(Class<? extends CustomActivity> clazz) {
        if (activityList == null || activityList.size() == 0) {
            return;
        }
        for (CustomActivity activity : activityList) {
    ...
    public static boolean isActivityExist(Class<? extends CustomActivity> clazz) {
        if (activityList == null || activityList.size() <= 0) {
            return false;
        }
