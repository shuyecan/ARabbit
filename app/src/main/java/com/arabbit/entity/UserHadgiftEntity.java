...
public class UserHadgiftEntity {
    private int total_page;
    private List<UserHadgiftEntity.ListsBean> lists;
    ...
    public List<UserHadgiftEntity.ListsBean> getLists() {
        return lists;
    }

    public void setLists(List<UserHadgiftEntity.ListsBean> lists) {
        this.lists = lists;
    }
    public static class ListsBean {
        ...
        public int getHadgift_id() {
            return hadgift_id;
        }

        public void setHadgift_id(int hadgift_id) {
            this.hadgift_id = hadgift_id;
        }
