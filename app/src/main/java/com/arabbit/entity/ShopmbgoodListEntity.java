...
public class ShopmbgoodListEntity {
    private int total_page;
    private List<ShopmbgoodListEntity.ListsBean> lists;
    ...
    public List<ShopmbgoodListEntity.ListsBean> getLists() {
        return lists;
    }
    public void setLists(List<ShopmbgoodListEntity.ListsBean> lists) {
        this.lists = lists;
    }
