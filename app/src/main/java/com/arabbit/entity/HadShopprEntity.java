...
public class    HadShopprEntity  {
    private int total_page;
    private List<HadShopprEntity.ListsBean> lists;
    ...
    public List<HadShopprEntity.ListsBean> getLists() {
        return lists;
    }
    public void setLists(List<HadShopprEntity.ListsBean> lists) {
        this.lists = lists;
    }
