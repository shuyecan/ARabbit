...
import com.arabbit.view.banner.listener.OnBannerClickListener;
import com.arabbit.view.banner.listener.OnBannerListener;
import com.arabbit.view.banner.loader.ImageLoaderInterface;
import com.arabbit.view.banner.view.BannerViewPager;
...
public class Banner extends FrameLayout implements OnPageChangeListener {
    ...
    private LinearLayout titleView_custom;
    private TextView tv_title_custom, tv_title_numinside_custom, tv_content_custom;
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        titleView_custom = (LinearLayout) view.findViewById(R.id.titleView_custom);
        ...
        tv_title_custom = (TextView) view.findViewById(R.id.tv_title_custom);
        tv_title_numinside_custom = (TextView) view.findViewById(R.id.tv_title_numinside_custom);
        tv_content_custom = (TextView) view.findViewById(R.id.tv_content_custom);
        initViewPagerScroll();
    }
    ...
    public Banner setBannerContents(List<String> contents) {
    ...
    public void updateBannerStyle(int bannerStyle) {
        ...
        titleView_custom.setVisibility(View.GONE);
        this.bannerStyle = bannerStyle;
        start();
    }
    ...
    private void setTitleStyleUI() {
        ...
        if (titles != null && titles.size() > 0) {
            ...
            tv_title_custom.setText(titles.get(0));//自定义样式设置标题

            if (bannerStyle != BannerConfig.NUM_INDICATOR_TITLE_CUSTOM) {
        ...
        if (contents != null && contents.size() > 0) {
            tv_content_custom.setText(contents.get(0));
        }
    ...
    private void setBannerStyleUI() {
        ...
        switch (bannerStyle) {
            ...
            case BannerConfig.CIRCLE_INDICATOR_TITLE_INSIDE:
                ...
                setTitleStyleUI();
                break;
            case BannerConfig.NUM_INDICATOR_TITLE_CUSTOM:
                titleView_custom.setVisibility(visibility);
                setTitleStyleUI();
                break;
        }
    }
    ...
    private void initImages() {
        ...
        } else if (bannerStyle == BannerConfig.NUM_INDICATOR_TITLE_CUSTOM) {
            tv_title_numinside_custom.setText("1/" + count);
        }
    }
    ...
    public void onPageSelected(int position) {
        ...
        switch (bannerStyle) {
            ...
            case BannerConfig.NUM_INDICATOR_TITLE:
                ...
                break;
            case BannerConfig.NUM_INDICATOR_TITLE_CUSTOM:
                tv_title_numinside_custom.setText(position + "/" + count);
                tv_title_custom.setText(titles.get(position - 1));
                tv_content_custom.setText(contents.get(position - 1));
                break;
            case BannerConfig.CIRCLE_INDICATOR_TITLE:
                bannerTitle.setText(titles.get(position - 1));
                break;
