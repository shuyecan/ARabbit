package com.arabbit.view.spinner.widget;
...
import com.arabbit.view.spinner.utils.DensityUtils;
...
//                throw new RuntimeException("the list has no the default.-by margintop");
    ...
    public int getSelectPosition() {
        int current = mDataList.indexOf(mCurrentItem);
        return current;
    }
    ...
    public void setSelection(int position) {
        ...
        if (mOnSpinnerListener != null) {
            mOnSpinnerListener.onSpinnerItemSelected(value, this);
            if (mPreItem != null && !TextUtils.equals(mPreItem, value)) {
                mOnSpinnerListener.onSpinnerItemChanged(value, this);
            }
        }
        mCurrentItem = value;
    ...
    public void setSelectTextColor(int colorId) {
        mTvSelected.setTextColor(colorId);
    }
