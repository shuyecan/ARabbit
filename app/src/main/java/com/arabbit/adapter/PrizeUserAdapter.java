...
public class PrizeUserAdapter extends BaseAdapter implements View.OnClickListener {
    ...
    public  PrizeUserAdapter(Context context, List list,Callback callback) {
    ...
    public View getView(final int position, View view, ViewGroup arg2) {
        PrizeUserAdapter.ViewHolder holder = null;

        if (view == null) {
            view = LayoutInflater.from(mContext).inflate(R.layout.item_prizeuser, null);
            holder = new PrizeUserAdapter.ViewHolder(view);
            view.setTag(holder);
        } else {
            holder = (PrizeUserAdapter.ViewHolder) view.getTag();
        }
