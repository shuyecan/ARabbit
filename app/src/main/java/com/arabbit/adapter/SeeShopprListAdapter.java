...
public class SeeShopprListAdapter extends BaseAdapter {
    ...
    public SeeShopprListAdapter(Context context, List list) {
//        super(context, list);
    ...
    public View getView(final int position, View view, ViewGroup arg2) {
        SeeShopprListAdapter.ViewHolder  holder= null;
        if (view == null) {
            view = LayoutInflater.from(mContext).inflate(R.layout.item_seepro, null);
            holder = new  SeeShopprListAdapter.ViewHolder(view);
            view.setTag(holder);
        } else {
            holder = (SeeShopprListAdapter.ViewHolder) view.getTag();
        }
