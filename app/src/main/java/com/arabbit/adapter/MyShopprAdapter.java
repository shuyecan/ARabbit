...
public class MyShopprAdapter extends BaseAdapter {

    Context mContext;
    List mList;


    public MyShopprAdapter(Context context, List list) {
//        super(context, list);
    ...
    public View getView(final int position, View view, ViewGroup arg2) {
        MyShopprAdapter.ViewHolder  holder= null;
        if (view == null) {
            view = LayoutInflater.from(mContext).inflate(R.layout.item_myprize, null);
            holder = new  MyShopprAdapter.ViewHolder(view);
            view.setTag(holder);
        } else {
            holder = (MyShopprAdapter.ViewHolder) view.getTag();
        }
