...
public class JoinUserAdapter  extends BaseAdapter  implements View.OnClickListener{
    ...
    public JoinUserAdapter(Context context, List list,JoinUserAdapter.Callback callback) {
//        super(context, list);
    ...
    public View getView(final int position, View view, ViewGroup arg2) {
        JoinUserAdapter.ViewHolder holder = null;

        if (view == null) {
            view = LayoutInflater.from(mContext).inflate(R.layout.item_joinuser, null);
            holder = new JoinUserAdapter.ViewHolder(view);
            view.setTag(holder);
        } else {
            holder = (JoinUserAdapter.ViewHolder) view.getTag();
        }
        UserJoingiftEntity.ListsBean entity = (UserJoingiftEntity.ListsBean) mList.get(position);
