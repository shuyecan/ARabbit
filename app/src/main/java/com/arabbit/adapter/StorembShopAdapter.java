...
public class StorembShopAdapter extends BaseAdapter {

    List<UserInfoEntity> userEntity;
    Context context;
    public StorembShopAdapter(List<UserInfoEntity> userEntity, Context context){
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        StorembShopAdapter.ViewHolder holder;
        if(view == null){
            holder = new StorembShopAdapter.ViewHolder();
            ...
            holder = (StorembShopAdapter.ViewHolder)view.getTag();
        }
