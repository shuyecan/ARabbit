...
public class ShopPrListAdapter extends BaseAdapter implements View.OnClickListener{

    Context mContext;
    List mList;
    String mtype="";
    private ShopPrListAdapter.Callback mCallback;
    ...
    public ShopPrListAdapter(Context context, List list,Callback callback) {
//        super(context, list);
        this.mContext = context;
        this.mList = list;
        mCallback = callback;
    }
    public ShopPrListAdapter(Context context, List list, ShopPrListAdapter.Callback callback, String type) {
//        super(context, list);
        this.mContext = context;
        this.mList = list;
        mCallback = callback;
    ...
    public View getView(final int position, View view, ViewGroup arg2) {
        ShopPrListAdapter.ViewHolder  holder= null;
        if (view == null) {
            view = LayoutInflater.from(mContext).inflate(R.layout.item_prize, null);
            holder = new  ShopPrListAdapter.ViewHolder(view);
            view.setTag(holder);
        } else {
            holder = (ShopPrListAdapter.ViewHolder) view.getTag();
        }
        ShopprListEntity.ListsBean entity = (ShopprListEntity.ListsBean) mList.get(position);
